 ...
 *   https://datatables.net/download/#bs/dt-1.10.15/r-2.1.1/rg-1.0.0/rr-1.2.0/sc-1.4.2
 *
 * Included libraries:
 *   DataTables 1.10.15, Responsive 2.1.1, RowGroup 1.0.0, RowReorder 1.2.0, Scroller 1.4.2
 */
...
(function( $, window, document, undefined ) {
	...
	function _fnReDraw( settings, holdPosition )
	{
		...
		// var any modules know about the draw hold position state (used by
	...
	function _fnBuildAjax( oSettings, data, fn )
	{
		...
		{
			// Is a function - var the caller define what needs to be done
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sInfo": "Exibindo _START_ a _END_ do total de _TOTAL_ entradas",
			 ...
			 *    } );
			 */
			"sInfoEmpty": "Exibindo 0 a 0 de um total de 0 entradas",
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs/dt-1.10.15/r-2.1.1/rg-1.0.0/rr-1.2.0/sc-1.4.2",
	...
	_columnsVisiblity: function ( breakpoint )
	{
		...
		for ( i=0, ien=order.length ; i<ien ; i++ ) {
			...
			if ( display[colIdx] === '-' && ! columns[colIdx].control && columns[colIdx].minWidth ) {
				// Once we've found a column that won't fit we don't var any
